...
Evidence digest: v4 deterministic active-perception benchmark, seven seeds, four tasks, five splits, nine methods, ablations, stress sweep, paired confidence intervals, and failure cases; v4.1 rerun reproduced the same terminal gate failure.
