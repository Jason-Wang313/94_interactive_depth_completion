...
PAPER = ROOT / "paper"
PDF = Path("C:/Users/wangz/Downloads/94.pdf")
DESKTOP_PDF = Path("C:/Users/wangz/Desktop/94.pdf")
...
def main():
    ...
    for token in [
        ...
        "KILL/ARCHIVE",
        "Interactive Depth Completion Under Hostile Review",
    ...
    for token in ["kill/archive", "interactive depth", "fixed-risk", "active view"]:
    ...
    print(f"validated Paper 94 artifacts: pages={pages}, sha256={sha256(PDF)}")
